    ...
    try {
      ...
      const mailOptions = {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p><a href="https://crm.zoomcreatives.jp" style="background-color: #FEDC00; color: #000; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 20px 0;">Login to Your Account</a></p>
